export default function DocsPage() {
  const steps = [
    ...
    "Если база уже создана, сразу после этого выполнить `supabase/sql/20260504_realtime_signal_setup.sql`, чтобы бот и сайт начали получать realtime-сигналы по настройкам, КВ и выбросам.",
