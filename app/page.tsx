        ...
        <div className="container sc-hero-grid">
          <div className="sc-hero-copy">
            ...
            <p>
              ...
              публикует итоги, собирает отряды, показывает зарегистрированных друзей и помогает игрокам привязать STALCRAFT-профиль.
            ...
            <div className="sc-mission-strip">
              <div><strong>Assist</strong><span>живой обзор через /sc-assist</span></div>
        ...
        <div className="container">
          ...
          <div className="sc-ops-grid">
            {[
              ...
              ["SC Assistant", "Команда /sc-assist показывает обзор сервера, проверяет настройки, открывает ссылки и помогает штабу не искать нужный раздел вручную."],
              ["Отряды КВ", "Офицеры создают отряды и распределяют игроков клана перед турниром или потасовкой."],
              ["Мини-игры", "Баланс жетонов, ежедневный схрон, моментка Зоны и простые ставки для активности игроков."],
