const commands = [
  ...
  ["sc-squad list/create/add/remove/delete", "Создаёт отряды КВ и распределяет игроков клана. Управление доступно офицеру и выше."],
  ["sc-friends", "Показывает зарегистрированных друзей STALCRAFT, которых удалось сопоставить через EXBO/API."],
  ["sc-game balance/daily/momentka/coinflip", "Мини-игры: баланс жетонов, ежедневный схрон, моментка Зоны и ставка на монету."],
