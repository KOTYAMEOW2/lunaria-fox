const commands = [
  ...
  ["sc-cw upload-tabs", "Загружает табы через Discord: текст, TXT/CSV или скрин с OCR."],
  ["sc-cw clear-tabs", "Очищает очередь табов КВ до публикации итогов."],
  ["sc-cw publish-results", "Отправляет итоги КВ и очищает очередь Supabase."],
  ["sc-squad list/create/add/remove/delete/publish", "Создаёт отряды КВ, распределяет игроков и публикует таблицу состава в привязанный Discord-канал. Управление доступно офицеру и выше."],
